      ...
      <div class="row">
        <div class="box">
          <div class="col-lg-12">
            ...
            <form>
				   <input type="text" name="itemid" id="item_id">&nbsp;&nbsp;&nbsp;&nbsp;
				   <input class="btn btn-primary" type="submit" value="Find Item" onclick="handleClick();return false"><br>
			</form>
			</h2>
			<hr>
          </div>
          ...
          <div class="col-md-6">
			...
			<img style="width: 400px;height: 400px;" class="img-responsive" src="" id="img1"/><br>
			</div>
